...
chmod +x $HOME/cosmos_node_monitoring/add_validator.sh "https://raw.githubusercontent.com/ERNcrypto/Testnet-Manuals/main/cosmos_node_monitoring/add_validator.sh"
