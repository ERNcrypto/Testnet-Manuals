...
```
wget -O install_monitoring.sh https://github.com/ERNcrypto/Testnet-Manuals/blob/main/cosmos_node_monitoring/install_monitoring.sh && chmod +x install_monitoring.sh && ./install_monitoring.sh
```
