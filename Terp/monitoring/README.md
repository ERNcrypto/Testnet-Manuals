...
<a href="https://ernventures.com/" target="_blank">Visit our website 
</p>
...
```
wget -O install_exporters.sh https://raw.githubusercontent.com/ERNcrypto/Testnet-Manuals/main/cosmos_node_monitoring/install_exporters.sh && chmod +x install_exporters.sh && ./install_exporters.sh
```
...
```
wget -O install_monitoring.sh https://raw.githubusercontent.com/ERNcrypto/Testnet-Manuals/main/cosmos_node_monitoring/install_exporters.sh && chmod +x install_monitoring.sh && ./install_monitoring.sh
```
...
![image](https://raw.githubusercontent.com/stasiaantonova/my/main/img/160629676-bc3c4f0f-66df-4a5f-9844-dca308072e7a.png)
